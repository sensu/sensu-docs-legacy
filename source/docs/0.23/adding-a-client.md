...
monitoring data (e.g. [client keepalives][?] and [check results][?]). Please
...
[6]:  configuration
[7]:  clients#registration-and-registry
[8]:  clients#client-definition-specification
[9]:  transport#transport-definition-specification
[10]: transport
[11]: rabbitmq
[12]: transport#selecting-a-transport
[13]: redis
[14]: client#client-keepalives
[15]: checks#check-results
