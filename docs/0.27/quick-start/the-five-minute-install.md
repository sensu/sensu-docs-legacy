...
5. Configure Sensu by downloading this [example configuration file][10]:
   ...
   ~~~ shell
   sudo wget -O /etc/sensu/config.json https://sensuapp.org/docs/0.27/files/simple-sensu-config.json
   ~~~
...
6. Configure the Sensu client by downloading this [example configuration
   ...
   ~~~ shell
   sudo wget -O /etc/sensu/conf.d/client.json https://sensuapp.org/docs/0.27/files/simple-client-config.json
   ~~~
...
7. Configure a Sensu dashboard by downloading this [example configuration
   ...
   ~~~ shell
   sudo wget -O /etc/sensu/dashboard.json https://sensuapp.org/docs/0.27/files/simple-dashboard-config.json
   ~~~
...
[10]: /docs/0.27/files/simple-sensu-config.json
[11]: /docs/0.27/files/simple-client-config.json
[12]: /docs/0.27/files/simple-dashboard-config.json
