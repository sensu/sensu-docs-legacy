...
version 0.27 or later and Sensu Enterprise 2.0 or later._
...
by taking advantage of [per-client subscriptions][4] added in Sensu 0.27, e.g.
`client:$CLIENT_NAME`.
...
_NOTE: Starting with version 0.27, Sensu clients automatically add a
...
clients to run Sensu 0.27+, or be manually configured with a `client:`
subscription._
...
Prior to Sensu 0.27 the ability to silence notifications was implemented in
