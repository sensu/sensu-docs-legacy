...
1. Download Sensu from the [Sensu Downloads][1] page, or by using this link:
   ...
   [https://sensu.global.ssl.fastly.net/freebsd/10.0/amd64/sensu-0.27.1_1.txz][3]
...
2. Install the `sensu-0.27.1_1.txz` package using the `pkg` utility:

   ~~~ shell
   sudo pkg add ./sensu-0.27.1_1.txz
   ~~~
...
[3]:  https://sensu.global.ssl.fastly.net/freebsd/10.0/amd64/sensu-0.27.1_1.txz
