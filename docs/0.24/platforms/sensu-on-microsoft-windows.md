...
1. Download Sensu from the [Sensu Downloads][1] page, or by using this link:
   ...
   [http://sensu.global.ssl.fastly.net/msi/sensu-0.24.0-1.msi][3]
...
[2]:  http://sensu.global.ssl.fastly.net/msi/
[3]:  http://sensu.global.ssl.fastly.net/msi/sensu-0.24.0-1.msi
