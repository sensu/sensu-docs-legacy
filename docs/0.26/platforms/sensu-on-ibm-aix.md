...
1. Download Sensu from the [Sensu Downloads][1] page, or using the `wget`
   ...
   ~~~ shell
   wget https://sensu.global.ssl.fastly.net/aix/sensu-0.26.3-1.powerpc.bff
   ~~~
...
2. The Sensu installer package for IBM AIX systems is provided in **backup file
   ...
   ~~~ shell
   installp -ld sensu-0.26.3-1.powerpc.bff
   ~~~
   ...
   ~~~ shell
   installp -apXY -d sensu-0.26.3-1.powerpc.bff sensu
   ~~~

3. Install Sensu using the `installp` utility.

   ~~~ shell
   installp -aXY -d sensu-0.26.3-1.powerpc.bff sensu
   ~~~
...
[3]:  https://sensu.global.ssl.fastly.net/aix/sensu-0.26.3-1.powerpc.bff
